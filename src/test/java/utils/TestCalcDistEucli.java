...
public class TestCalcDistEucli {
    ...
    public void test_calc_dist_eucli(){
        assertEquals(5, CalculDistanceEucli.calculDistanceEucli(0, 3, 0, 4));
        assertEquals(5, CalculDistanceEucli.calculerDistanceEucli(dataPoint1, dataPoint2, axeX, axeY));
        assertEquals(5, CalculDistanceEucli.calculerDistanceEucli(dataPoint2, dataPoint1, axeX, axeY));
        assertEquals(5, CalculDistanceEucli.calculerDistanceEucli(dataPoint3, dataPoint4, axeX, axeY));
        assertEquals(5, CalculDistanceEucli.calculerDistanceEucli(dataPoint4, dataPoint3, axeX, axeY));
    }
}
